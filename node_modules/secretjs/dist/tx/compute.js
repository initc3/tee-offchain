...
exports.MsgStoreCode = exports.MsgExecuteContract = exports.MsgInstantiateContract = exports.getMissingCodeHashWarning = void 0;
...
class MsgInstantiateContract {
    constructor({ sender, code_id, label, init_msg, init_funds, code_hash, }) {
    ...
    toProto(utils) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const msgContent = {
                sender: (0, query_1.addressToBytes)(this.sender),
                code_id: this.codeId,
                label: this.label,
...
class MsgExecuteContract {
    ...
    toProto(utils) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const msgContent = {
                sender: (0, query_1.addressToBytes)(this.sender),
                contract: (0, query_1.addressToBytes)(this.contractAddress),
